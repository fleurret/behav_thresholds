function one_subject_threshold_rep(pth, maxdays, yl)

% plot settings
f = figure();
f.Position = [0, 0, 1200, 250];
ax = gca;
...
c = [0,0,0;...
    ...
    176, 176, 176;...
    198, 198, 198]./255;
ax(1) = subplot(1,5,1:2);
ax(2) = subplot(1,5,3:5);
...
set(ax(1), 'XLim', [-30 5],...
    ...
    'LineWidth',2,...
    'FontSize',14);
set(ax(2), 'XLim', [min(xlim)-0.1 max(xlim)+0.1],...
    'XTick', log10(days)+1,...
    'XTickLabel', days,...
...
ylabel(ax(1),'d''',...
    'FontWeight','bold',...
    'FontSize', 14);
xlabel(ax(2),'Perceptual training day',...
    'FontWeight','bold',...
    'FontSize', 14);
ylabel(ax(2),'Threshold (dB re: 100%)',...
    'FontWeight','bold',...
    'FontSize', 14);
